...
************************************************************************
*!C-INC
* Purpose:   Utilities header file containing constants for MOD02 and MOD03
...
*
*              L1B EV 1km                   vers 6.0.0       May 22, 2008
*              L1B EV 500m                  vers 6.0.0       May 22, 2008
*              L1B EV 250m                  vers 6.0.0       May 22, 2008
*              L1B OBC (partial coverage)   vers 6.0.0       May 22, 2008
*              MOD03.ASCII.fs               vers 6.0.1       Mar 30, 2010
*              MOD03CP.ASCII.fs             vers 5.0.0       Nov 29, 2004
*
*
...
*!Revision History: 
* $Log: mapiL1Bgeo.h,v $
* Revision 6.2  2010/05/12 19:46:23  kuyper
* Added more descriptive comments.
*
* Revision 6.1  2010/05/11 20:32:57  kuyper
* Updated to reflect changes in the L1B and Geolocation filespecs between the
*   last time this file was up-to-date and the latest Collection 6 products.
*
* James Kuyper		James.R.Kuyper@NASA.gov
*
* Revision 5.2  2005/04/21 15:11:01  vlin
* MOD03 macros added on 2005/04/11 15:11:01 in wrong location.
*
* Revision 5.1  2005/04/21 14:21:41  vlin
* MOD03 macros added.   vlin@saicmodis.com
*
...
/* Obsolete: replaced by M02_1KM_GEO_DIM		 */
...
#define M02_1KM_GEO_DIM		"1KM_geo_dim"
...
/*  Earth View Band 26 Scaled  */
/*     Integer Radiance Uncertainty SDS     */
#define M02EARTH_BAND26_UNCERT     "EV_Band26_Uncert_Indexes"
#define M02EV_BAND26_UNCERT_IDX       M02EARTH_BAND26_UNCERT 
...
/*      Twice the maximum number of Earth view frames per scan    */ 
#define M03MFRAMES_2		"mframes*2" 

/*      Four times the maximum number of Earth view frames per scan    */ 
#define M03MFRAMES_4		"mframes*4" 

/*      Number of MODIS scans times 10      */ 
#define M03NSCANS_10           "nscans*10" 

/*      Number of MODIS scans times 20      */ 
#define M03NSCANS_20           "nscans*20" 

/*      Number of MODIS scans times 40      */ 
#define M03NSCANS_40           "nscans*40" 

/*      Mirror encoder data values per scan      */ 
#define M03NUMENC              "numenc" 

/*      SDS attribute names         */
/*		Names for SDS columns.	*/
#define M03SCAN_D              "scandim"
#define M03TRACK_D             "trackdim"
#define M03ROLL_ELEM           "roll_element" 
#define M03PITCH_ELEM          "pitch_element"
#define M03YAW_ELEM            "yaw_element"   
/*		Quality Flag SDS bit flag names. */
#define M03QFL_OVERALL		"overall"
#define M03QFL_DATASUM		"data_summary"
#define M03QFL_RED_LO		"red_limit_low"
#define M03QFL_YEL_LO		"yellow_limit_low"
#define M03QFL_YEL_HI		"yellow_limit_high"
#define M03QFL_RED_HI		"red_limit_high"
#define M03QFL_LONG_FOLL	"long_gap_follows"
#define M03QFL_SHRT_FOLL	"short_gap_follows"
#define M03QFL_SHRT_PREC	"short_gap_precedes"
#define M03QFL_LONG_PREC	"long_gap_precedes"
#define M03QFL_REPAIRED		"repaired_data_point"
#define M03QFL_QFL_PROB		"quality_flag_problem"
#define M03QFL_INTERP		"interpolated_point"
...
/*	Number of the band used for high-resolution geolocation. */
#define	M03BAND_NUMBER		"band_number"
...
/*	Scan type ("Day", "Night" or "Other")	    */
#define M03SCAN_TYPE        "Scan Type"
...
#define M03THERM_CORR		"thermal_correction"

/*	Quality flags for attitude data	*/
#define M03ATT_QUALITY		"attitude_quality"

/*	Quality flags for ephemeris data	*/
#define M03EPH_QUALITY		"ephemeris_quality"
...
/*	Names of the inputs used to create the attitude files	*/
#define M03ATTIT_INPUT          "Attitude Input Files"

/*	Names of the inputs used to create the ephemeris files	*/
#define M03EPHEM_INPUT          "Ephemeris Input Files"

/*	Version of the maneuver file used as input (obsolete in PGE01 6.0.3+) */
#define M03MANEUVER_V           "Maneuver File Version"

/*	Polar wandering parameters: x, y, and UT1-UTC		*/
#define M03POLAR_MOTION         "Polar Motion"

/*	The first (header) line of the utcpole.dat file.	*/
#define M03UTCPOLE              "utcpole File Header"

/*	Terrain Correction Flag: "True" or "False"		*/
#define M03TERR_CORR		"Terrain Correction Flag"
...
/*	Offset to bilinear interpolation factor in scan direction, to	*/
/*	interpolate high-resolution geolocation from 1km geolocation.	*/
#define M03SCAN_OFFSET		"Scan Offset"

/*	Offset to bilinear interpolation factor in track direction, to	*/
/*	interpolate high-resolution geolocation from 1km geolocation.	*/
#define M03TRACK_OFFSET		"Track Offset"

/*	Offset in the vertical direction of the high-resolution		*/
/*	geolocation from bilinearly interpolated 1km geolocation.	*/
#define M03HEIGHT_OFFSET	"Height Offset"
...
/***********************************************************
 *         Geolocation Vdata Names                         *
 ***********************************************************/
/*	Average temperatures Vdata	*/
#define M03AVG_TEMP             "Average Temperatures"

/***********************************************************
 *         Geolocation Vdata Field Names                   *
 ***********************************************************/
/*	Radiative Cooler SMIR Cold Focal Plane Assembly temperature	*/
#define M03TEMP_TRS             "TA_RC_SMIR_CFPA"

/*	Aft Optics SMIR OBJective lens assembly temperature		*/
#define M03TEMP_TAS             "TP_AO_SMIR_OBJ"

/*	MainFrame CALibration BulKHeaD below SRCA mount temperature	*/
#define M03TEMP_TMC             "TP_MF_CALBKHD_SR"

/*	MainFrame mid Zenith BulKHeaD near BB temperature		*/
#define M03TEMP_TMZ             "TP_MF_Z_BKHD_BB"

/*	Scan Assembly MIRror Radiatively Coupled Temperature 1 monitor	*/
#define M03TEMP_TSR             "TP_SA_RCT1_MIR"

/*	SRCA OUTput collimator temperature				*/
#define M03TEMP_TSS             "TP_SR_SNOUT"
...
#define M03CP_MANVR_FLAG	"Maneuver Flag"
