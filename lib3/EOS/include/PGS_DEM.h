...
subgrid -- is all the data which covers a particular, pre-defined and 
resolution specific geographic area.  For example, for the 3 arc secod 
resolution a subgrid would be all the files which cover one 10 degree 
by 10 degree section of the world.
...
file -- is an individual UNIX file.  For this tool we have used the HDF-EOS 
file format. a file is actually the intersection of a particular subgrid with a
particular subset.  

   An example:
        for the 3 arc second resolution of the world one would have:
	1 dataset of 3 arc second data.
	648 subgrids of 10 degree by 10 degree geographic sections of the 
        world.
...
history --
January,   21, 1997 AZ          first created
July       31, 1997 AZ          Added bilinear interpolation functions, 
                                changed quality flags
September, 10, 1997 Abe Taaheri added land/sea mask idntifiers
June,       5, 2000 Abe Taaheri added tags for 3km resolution
September, 14, 2011 Abe Taaheri added tags for 500m (15 arcsec) resolution
                                added actual fillvalue for land/water mask
...
#define FLT_EPSILON_DEF     1.19209290E-07
...
#define  PGSd_DEM_15ARC        5 /*15 arc second data set, ~500m postings*/
...
#define PGSd_DEM_MAX_RESOLUTIONS   4
#define PGSd_DEM_LW_FILLVALUE -35
#endif
...
#define  PGSd_DEM_SUBSET15A     10659  /*One of 15 arc second subsets*/
#define  PGSd_DEM_SUBSET15B     10660  /*One of 15 arc second subsets*/
#define  PGSd_DEM_SUBSET15C     10661  /*One of 15 arc second subsets*/
...
#define  PGSd_DEM__LW_FILLVALUE    -35   /*fill value for Land/Water and other
					   INT8 attributes*/
...
#define PGSm_DEM_LatToPixel(lat, subsetInfo) \
	 (PGSt_integer)(subsetInfo -> offset + ((90.0 - lat) * \
						(subsetInfo -> pixPerDegree))+FLT_EPSILON_DEF)
