...
HISTORY:
  ...
  05-Jul-2007 AT  Changed definition of PGSd_TOOLKIT_MAJOR_VERSION from
                  TK5.2.14 to TK5.2.15 for ECS drop 7A
  20-May-2009 AT  Changed definition of PGSd_TOOLKIT_MAJOR_VERSION from
                  TK5.2.15 to TK5.2.16 for ECS drop 7A
  27-July-2010 AT  Changed definition of PGSd_TOOLKIT_MAJOR_VERSION from
                  TK5.2.16 to TK5.2.17 for ECS drop 7A
  15-Dec-2011 AT  Changed definition of PGSd_TOOLKIT_MAJOR_VERSION from
                  TK5.2.17 to TK5.2.18 for ECS drop
END_FILE_PROLOG:
*****************************************************************/
...
#if !( defined(LINUX) || defined(LINUX32) || defined(LINUX64) || defined(IA64) || defined(MACINTOSH) || defined(MACINTEL) || defined(CYGWIN) ) /* for linux the following 
						 is not needed */
...
#define PGSd_TOOLKIT_MAJOR_VERSION       "TK5.2.18"
#ifdef PGS_DAAC
...
#ifdef PGS_DAAC
#    define PGSd_TOOLKIT_VERSION_STRING "DAAC  TK5.2.18"
#else
#    define PGSd_TOOLKIT_VERSION_STRING  "SCF  TK5.2.18"
#endif
