...
HISTORY:
        ...
        22-Dec-1999 AT  Added keys in support of PM's GIIS and GIRD 
                        time formats
        5-June-2000 AT  Added keys in support of DEM's 3km resolution
	14-Sep-2011 AT  Added keys in support of DEM's 500m (15 arcsec) 
                        resolution
...
#define PGSd_TSF_KEYDEMINFO15ARC1 			57
#define PGSd_TSF_KEYDEMINFO15ARC2 			58
#define PGSd_TSF_KEYDEMINFO15ARC3 			59
#define PGSd_TSF_KEYDEMSUBSET15ARC1 			60
#define PGSd_TSF_KEYDEMSUBSET15ARC2 			61
#define PGSd_TSF_KEYDEMSUBSET15ARC3 			62
typedef struct
{
