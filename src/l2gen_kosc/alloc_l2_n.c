...
/* --------------------------------------------------------- */
int alloc_l2_n( int32_t npix, int32_t nbands, l2str *l2rec )
{
     char *p;
     ...
     l2rec->aermodmin2= (int32_t   *) p;  p += sizeof(int32_t)*npix;
     l2rec->aermodmax2= (int32_t   *) p;  p += sizeof(int32_t)*npix;
     l2rec->aerratio2 = (float  *) p;  p += sizeof(float)*npix;
