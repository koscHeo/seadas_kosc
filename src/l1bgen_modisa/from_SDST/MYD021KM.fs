+=============================================================================+
|                                                                             |
|              L1B EV 1km File Specification -- MODIS/AQUA                    |
|                           V6.1.9, 11/15/2010                                |
|       Effective for all higher numbered versions until superceded           |
|                                                                             |
+=============================================================================+

   This document specifies the format for the MODIS/AQUA Level 1B 1km
...
| Name                                        Example                         |
+-----------------------------------------------------------------------------+
| LOCALGRANULEID                              "MYD021KM.A2001103.1555.002.    |
