...
{
    epr_uint le_value = EPR_LE_MAGIC_NUMBER;
    return (((epr_uchar*)(&le_value))[0] == EPR_LE_MAGIC_BYTE_0)
        && (((epr_uchar*)(&le_value))[1] == EPR_LE_MAGIC_BYTE_1)
        && (((epr_uchar*)(&le_value))[2] == EPR_LE_MAGIC_BYTE_2)
        && (((epr_uchar*)(&le_value))[3] == EPR_LE_MAGIC_BYTE_3);
}
...
{
    epr_uint be_value = EPR_BE_MAGIC_NUMBER;
    return (((epr_uchar*)(&be_value))[0] == EPR_LE_MAGIC_BYTE_0)
        && (((epr_uchar*)(&be_value))[1] == EPR_LE_MAGIC_BYTE_1)
        && (((epr_uchar*)(&be_value))[2] == EPR_LE_MAGIC_BYTE_2)
        && (((epr_uchar*)(&be_value))[3] == EPR_LE_MAGIC_BYTE_3);
}
...
void epr_swap_endian_order(const EPR_SField* field)
{
    switch (field->info->data_type_id) {
        ...
        case e_tid_string:
            ...
            break;
        case e_tid_time:
            byte_swap_uint((epr_uint*)field->elems, 3);
            break;
        case e_tid_spare:
            /* no conversion required */
            break;
        case e_tid_ushort:
            byte_swap_ushort((epr_ushort*) field->elems, field->info->num_elems);
            break;
        case e_tid_short:
            byte_swap_short((short*) field->elems, field->info->num_elems);
            break;
        case e_tid_uint:
            byte_swap_uint((epr_uint*) field->elems, field->info->num_elems);
            break;
        case e_tid_int:
