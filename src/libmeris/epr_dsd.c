...
EPR_SDSD* epr_read_each_dsd(FILE* envisat_source_file, int* pos)
{
    ...
    for (l = 0; l <= l_limit; l++)
    {
        ...
        if (strncmp (code_block, "DS_NAME=\"", EPR_LENGTH_DS_NAME_IDENTIFIER) == 0)
        {
            ...
            if (((epr_uint)strlen(code_block) != (epr_uint)(EPR_LENGTH_DS_NAME_FIELD)) || ((epr_uint)(strrchr(code_block, ch) - code_block) != (epr_uint)(strlen(code_block) - 2)))
            {
            ...
            {
                if (((epr_uint)strlen(code_block) != (epr_uint)(EPR_LENGTH_DS_FILENAME_FIELD)) || ((epr_uint)(strrchr(code_block, ch) - code_block) != (epr_uint)(strlen(code_block) - 2)))
                {
                    epr_set_err(e_err_invalid_data_format,
            ...
            {
                if (((epr_uint)strlen(code_block) != (epr_uint)(EPR_LENGTH_DS_OFFSEN_FIELD)) || (strncmp(code_block + strlen(code_block) - strlen("<bytes>") - 1, "<bytes>", strlen("<bytes>")) != 0))
                {
                    epr_set_err(e_err_invalid_data_format,
                        "epr_read_each_dsd: invalid dataset filename format");
                    epr_free_dsd(dsd);
                ...
                dsd->ds_offset = (epr_uint)epr_str_to_number(tmp);
                epr_free_string(tmp);
                if (dsd->ds_offset == -1)
                {
                    epr_set_err(e_err_invalid_data_format,
            ...
            {
                if (((epr_uint)strlen(code_block) != (epr_uint)(EPR_LENGTH_DS_SIZE_FIELD)) || (strncmp(code_block + strlen(code_block) - strlen("<bytes>") - 1, "<bytes>", strlen("<bytes>")) != 0))
                {
                    epr_set_err(e_err_invalid_data_format,
                        "epr_read_each_dsd: invalid dataset filename format");
                    epr_free_dsd(dsd);
                ...
                dsd->ds_size = (epr_uint)epr_str_to_number(tmp);
                epr_free_string(tmp);
                if (dsd->ds_size == -1)
                {
                    epr_set_err(e_err_invalid_data_format,
            ...
            {
                if ((epr_uint)strlen(code_block) != (epr_uint)(EPR_LENGTH_NUM_DSR_FIELD))
                {
                    epr_set_err(e_err_invalid_data_format,
                ...
                dsd->num_dsr = (epr_uint)epr_str_to_number(tmp);
                epr_free_string(tmp);
                if (dsd->num_dsr == -1)
                {
                    epr_set_err(e_err_invalid_data_format,
            ...
            {
                if (((epr_uint)strlen(code_block) != (epr_uint)(EPR_LENGTH_DSR_SIZE_FIELD)) || (strncmp(code_block + strlen(code_block) - strlen("<bytes>") - 1, "<bytes>", strlen("<bytes>")) != 0))
                {
                    epr_set_err(e_err_invalid_data_format,
                ...
                dsd->dsr_size = (epr_uint)epr_str_to_number(tmp);
                epr_free_string(tmp);
                if (dsd->dsr_size == -1)
                {
                    epr_set_err(e_err_invalid_data_format,
...
EPR_SPtrArray* epr_read_all_dsds(EPR_SProductId* product_id)
{
    ...
    dsd_begin = EPR_MPH_SIZE + (epr_uint)epr_find_first_dsd(product_id->istream, sph_length);
    ...
    for(dsd_index = 0; dsd_index < dsd_number; dsd_index ++) {
        ...
        if ((epr_uint)numread != EPR_DSD_SIZE) {
        ...
        */
        if ((strlen(code_block) > 0) && (code_block[0] != ' ')) {
            ...
            dsd->ds_type = epr_sub_string((char*)field->elems, 0, sizeof(epr_uchar));
            ...
            dsd->ds_offset = (epr_uint)((epr_uint*) field->elems)[0];

            field = epr_get_field(dsd_record, "DS_SIZE");
            dsd->ds_size = (epr_uint)((epr_uint*) field->elems)[0];

            field = epr_get_field(dsd_record, "NUM_DSR");
            dsd->num_dsr = (epr_uint)((epr_uint*) field->elems)[0];

            field = epr_get_field(dsd_record, "DSR_SIZE");
            dsd->dsr_size = (epr_uint)((epr_uint*) field->elems)[0];
