...
!Revision History:
   $Log: L1B_Setup.h,v $
   Revision 1.11  2006-10-30 10:00:12-05  ltan
   Changed for ANSI-C compliance. Correction for the generation of code change log.

   Revision 01.13, April 15, 2002  Razor Issue #182
   Applicable to MODIS/TERRA (PFM) processing only.
   Moved function prototype for Calculate_B26_B5_Correction to L1B_SetupP.h.
   Alice Isaacman, SAIC GSO (Alice.R.Isaacman.1@gsfc.nasa.gov)

   Revision 01.12, March 19, 2002  Razor Issue #182
   Applicable to MODIS/TERRA (PFM) processing only.
   Added function prototype for Calculate_B26_B5_Correction.
   Alice Isaacman, SAIC GSO (Alice.R.Isaacman.1@gsfc.nasa.gov)
