+=============================================================================+
|                                                                             |
|                 L1B EV 500m File Specification  -- TERRA                    |
|                           V6.1.8, 2010-11-15                                |
|       Effective for all higher numbered versions until superceded           |
|                                                                             |
+=============================================================================+

   This document specifies the format for the MODIS Level 1B 500m
...
| Name                                        Example                         |
+-----------------------------------------------------------------------------+
| LOCALGRANULEID                              "MOD02HKM.A1996218.1555.002.    |
|                                             1998152115306.hdf"              |
+-----------------------------------------------------------------------------+
...
|                                             Radiances 5-Min L1B Swath 500m" |
+-----------------------------------------------------------------------------+
