+=============================================================================+
|                                                                             |
|                   TERRA L1B OBC File Specification                          |
|                           V6.0.0, 05/22/2008                                |
|       Effective for all higher numbered versions until superceded           |
|                                                                             |
+=============================================================================+

   This document describes the format and content for the MODIS Level 1B on-
   board calibrator (OBC) product. The product is implemented in an HDF file.
...
| Name                                        Example                         |
+-----------------------------------------------------------------------------+
| LOCALGRANULEID                              "MOD02OBC.A1996218.1555.002.    |
|                                             1998152115306.hdf"              |
+-----------------------------------------------------------------------------+
...
+-----------------------------------------------------------------------------+
| LONGNAME                                    "MODIS/Terra On-Board Calibrator|
|                                             and Engineering Data 5-Min L1B" |
+-----------------------------------------------------------------------------+
...
|      "CS_PC_3132_SRISE"               UINT16         1                      |
|      "CS_PC_3132_SFALL"               UINT16         1                      |
|      "CS_PC_3334_SRISE"               UINT16         1                      |
|      "CS_PC_3334_SFALL"               UINT16         1                      |
|      "CS_PC_3536_SRISE"               UINT16         1                      |
|      "CS_PC_3536_SFALL"               UINT16         1                      |
